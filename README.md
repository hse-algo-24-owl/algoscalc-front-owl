...
## Ресурсы
- [Тестовый контур](https://owl.ommat.ru) клиентской части онлайн-калькулятора.
...
1. Клонируйте репозиторий:
    ...
    ```sh
    git clone https://github.com/hse-algo-24-owl/algoscalc-front-owl.git
    cd algoscalc-front-owl
    ```
